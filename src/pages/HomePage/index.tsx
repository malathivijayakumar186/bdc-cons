        ...
        <div className={style.homepart1}>
          ...
          <div className={style.headtext1}>
            ...
            <div className={style.headtext13}>
              ...
              play a part in fostering stronger family connections to be availed
              at your new home through our work, the relationships that we
              continue to build and the legacy that you will be leaving behind.
            </div>
          </div>
        </div>
        </Fade>
